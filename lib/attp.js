...
async function attpv2(text, outputFilePath, fontPath) {
  if (!text) {
    throw new Error("Está faltando o texto!");
  }
...
async function attpv3(text, outputFilePath, fontPath) {
  if (!text) {
    throw new Error("Está faltando o texto!");
  }
...
async function attpv4(text, outputFilePath, fontPath) {
  if (!text) {
    throw new Error("Está faltando o texto!");
  }
...
async function attpv5(text, outputFilePath, fontPath) {
  if (!text) {
    throw new Error("Está faltando o texto!");
  }
...
async function attpv6(text, outputFilePath, fontPath) {
  if (!text) {
    throw new Error("Está faltando o texto!");
  }
...
module.exports = { createAttp, attpv2, attpv3, attpv4, attpv5, attpv6 };
